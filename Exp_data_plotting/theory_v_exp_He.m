...
filename = '/home/rdoyle/MCMU/He/Monte-Carlo/data_stats.txt';
delimiter = {'       '};
startRow = 6;
...
% Script for importing data from the following text file:
%
%    filename: /home/rdoyle/MCMU/Exp_data_plotting/He/combined_exp.txt
%
% Auto-generated by MATLAB on 23-Jun-2021 17:17:53
...
opts = setvaropts(opts, ["VarName1", "VarName2", "VarName3"], "EmptyFieldRule", "auto");

% Import the data
exp_data = readmatrix("/home/rdoyle/MCMU/Exp_data_plotting/He/combined_exp.txt", opts);
...
mob_cp = str2double(exp_data(6:37,1:3));

mob_ku_name = exp_data(39,1);
mob_ku = str2double(exp_data(42:54,1:3));

mob_mc_name = exp_data(56,1);
mob_mc = str2double(exp_data(59:65,1:3));

mobility = [mob_cp ;mob_ku ;mob_mc];

diff_cv_name = exp_data(71,1);
diff_cv = str2double(exp_data(74:111,1:3));

diff_cr_name = exp_data(113,1);
diff_cr = str2double(exp_data(116:145,1:3));

diff_exp = [diff_cv; diff_cr];

char_war_name = exp_data(151,1);
char_war = str2double(exp_data(154:170,1:3));

char_cr_name = exp_data(172,1);
char_cr = str2double(exp_data(175:204,1:3));

char_al_name = exp_data(206,1);
char_al = str2double(exp_data(209:229,1:3));

char_exp = [char_al ;char_cr ;char_war];

ion_dav_name = exp_data(235,1);
ion_dav = str2double(exp_data(238:259,1:3));

ion_lak_name = exp_data(261,1);
ion_lak = str2double(exp_data(264:278,1:3));

ion_dal_name = exp_data(280,1);
ion_dal = str2double(exp_data(283:296,1:3));
